...
const ThinkingChainDemo: React.FC = () => {
      ...
      steps: [
        {
          id: "step-1",
          content:
            "首先，我需要分析当前工作效率低下的可能原因。常见的问题包括：时间管理不当、任务优先级不明确、工作环境干扰等。",
          stepType: "analysis",
        ...
        },
        {
          id: "step-2",
          content:
            "基于这些分析，我认为可以从以下几个方面来改进：1) 使用时间管理工具，2) 制定明确的任务清单，3) 创造专注的工作环境。",
          stepType: "reasoning",
        ...
        },
        {
          id: "step-3",
          content:
            "但是，这些方法是否真的适合每个人呢？不同的工作性质和个人习惯可能需要不同的解决方案。",
          stepType: "question",
        ...
        },
        {
          id: "step-4",
          content:
            "我建议可以尝试番茄工作法，这是一个经过验证的时间管理技巧，可以帮助保持专注并提高效率。",
          stepType: "idea",
        ...
        },
        {
          id: "step-5",
          content:
            "综合以上分析，提高工作效率的关键在于找到适合自己的方法组合，并持续优化和调整。",
          stepType: "conclusion",
  ...
  const [sampleData, setSampleData] = React.useState<ThinkingChainType | null>(
    null
  );
